...
public class UpdateData {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateData window = new UpdateData();
	...
	private void initialize() {
		...
		btnEnterInfo.setBounds(10, 201, 109, 23);
		...
		bloodlbl.setBounds(139, 102, 89, 20);
		frame.getContentPane().add(bloodlbl);
		
		JButton btnDeleteInfo = new JButton("Update Info");
		btnDeleteInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null, "Updated","Alert",JOptionPane.PLAIN_MESSAGE);
		...
		btnDeleteInfo.setBounds(139, 201, 109, 23);
